            ...
            <div class="product-details-wrapper">
                ...
                <div class="product-details-content">
                    <div class="product-details-tab-description">
                        <h3 class="product-details-tab-title">Description</h3>
                    ...
                    <div class="product-details-tab-reviews">
                        <h3 class="product-details-tab-title">Reviews</h3>
                        <div class="product-details-tab-reviews-content">
                            <p class="product-details-tab-reviews-heading">Reviews</p>
                            <span class="product-details-tab-text">There are no reviews yet.</span>
                            <div class="review-form">
                                <span class="comment-reply-title">
                                    <i class="far fa-edit"></i>BE THE FIRST TO REVIEW "ALVARADO SIDEBOARD"
                                </span>
                                <span class="product-details-tab-text">Your email address will not be published. Required fields are marked *</span>
                                ...
                                <div class="content-info-reviews">
                                    <div class="content-info-reviews-left">
                                        <input type="text" placeholder="Name*" class="input-reviews-name">
                                        <input type="text" placeholder="Email*" class="input-reviews-email">
