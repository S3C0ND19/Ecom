...
<?php include('includes/header.php'); ?>
        ...
        <?php include('includes/nav.php'); ?>
            <div class="myorder-container">
                ...
                <div class="order-shipping-info">
                    ...
                    <span class="order-shipping-info-status status">
                                <?php 
                                            if($status== 1)
                                                echo "Done";
                                            else
                ...
                <div class="order-shipping-info">
                    ...
                    <ul class="order-shipping-info-product-item">
                        ...
                        <li class="order-shipping-info-product-list">
                            <p class="order-shipping-info-product-total">$<?php echo $value['prd_price']; ?></p>
                        </li>
                        <li class="order-shipping-info-product-list">
    ...
    <script>
          const contentStatus = document.querySelectorAll('.order-shipping-info-status') 
         if(contentStatus[1].innerText == 'Done'){
            contentStatus[1].classList.toggle('done')  
        }
    </script>
</body>
</html>