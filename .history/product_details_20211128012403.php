            ...
            <div class="product-details-wrapper">
                <div class="full-screen">
                    <div class="product-details-container">
                        <div class="grid">
                            <form method="post" action="shop_paging.php?action=add&id='<?php echo $id ?>" class="form-submit">  
                            <div class="row">
                                    <div class="col l-7">
                                        ...
                                        <div class="product-details-information">
                                            ...
                                            <div class="product-details-description">
                                                ...
                                                if (isset($_SESSION["login"])){
                                                        echo "<button name='add_to_cart' type='submit' class='product-details-add-cart'>
                                                                ADD TO CART
                                                            </button>";
                                                }else {
                                                    echo "
                                                    <a href='login.php'>
                                                        <a href='login.php' class='product-details-add-cart'>
                                                                ADD TO CART
                                                        </a>'>
                                                    </a>
                                                    ";
                                                ...
                                                <div class="product-details-wishlist">
                                                    <button name="add_to_wishlist" type="submit" class="product-details-wishlist-link">
