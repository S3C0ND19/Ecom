                ...
                <div class="col l-3">
                  <div class="category">
                    <nav class="category-nav">
                      ...
                      <?php
                         $query = "SELECT DISTINCT(prd_cat_id) FROM product  ORDER BY prduct_id DESC";
                        ...
                        <li class="category-item">                          
                          <label>
                            <input type="checkbox" class="common_selector category category-item__link " value="<?php echo $value['cat_id'];?>" ><?php echo $value['cat_name'];?>
                          </label>
