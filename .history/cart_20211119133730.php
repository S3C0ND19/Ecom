...
if(isset($_SESSION["view_cart"]))  
{  
     $item_array_id = array_column($_SESSION["view_cart"], "item_id");  
     ...
     {  
          ...
          $_SESSION["view_cart"][$count] = $item_array;  
     }  
}  
else  
{  
     ...
     $_SESSION["view_cart"][0] = $item_array;  
} 
?>
                            ...
                            <div class="col l-8">
                              <!-- Form Cart -->
                                ...
                                if(!empty($_SESSION["view_cart"]))  
                                  {  
                                      $total = 0;  
                                      foreach($_SESSION["view_cart"] as $keys => $values)  
                                      {  
                              ?> 
