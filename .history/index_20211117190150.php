            ...
            <div class="form-register">
              ...
              <form class="register"  action="register_submit.php" method="POST">
                ...
                <div class="form-content">
                  ...
                  <div class="password">
                    <input type="password" class="form__input"  name="userPass" required placeholder="Password...">
                  </div>
                  <div class="password">
                    <input type="password" class="form__input"  name="userRePass" required placeholder="Repeat Password...">
                  </div>
