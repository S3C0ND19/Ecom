                      ...
                      <?php foreach ($navigation as $key => $value): ?>     
                        <li class="category-item">                          
                            <div class="category-item-check">
                              <input type="checkbox"  class="common_selector category" value="<?php echo $value['cat_id'];?>" id="cat_check" >
                              <label class="category-item__link" for="cat_check"><?php echo $value['cat_name'];?></label>
                            </div>
