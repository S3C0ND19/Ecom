 ...
 foreach($_SESSION["shopping_cart"] as $keys => $values)
 {
  ...
  <tr class="content__cart-items">                                               
      ...
      <td class="product-remove table-middle">
          <a href="shop_paging.php?action=delete&id='.$values["item_id"].'" class="product-remove__item">x</a>
      </td>
  </tr>
  ';
  ...
  <tr class="content__cart-actions">
      <td colspan="6" class="actions">
          <div class="content__cart-bottom">
              ...
              <button class="btn-submit__update" onclick="valueNumber()">UPDATE CART</button>
          </div>
      </td>
  </tr>
</table>';
