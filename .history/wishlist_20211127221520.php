                ...
                <tr>
                    ...
                    <td class="wishlist__product-img">
                        <a href="" class="wishlist__product-img-link">
                            ...
                            <input type="hidden" name="hidden_img" value="'.$values["item_img"].'" />  
                        </a>
                    </td>
                    ...
                    <td class="wishlist__product-add">
                        <a href="wishlist.php?action=add&id='.$values["item_id"].'"  class="wishlist__product-add-link">Add to Cart</a>
                    </td>
                </tr>
