...
$product = mysqli_query($conn,"SELECT * FROM product  WHERE prd_id IN (1,5,4)");
?>
                                            ...
                                            <tr class="content__cart-items">                                               
                                                <td class="product-thumbnail">
                                                    <a href="" class="content__cart-link-img">
                                                        <img src="./admin/upload/<?php echo $value['prd_img']; ?>" alt="" class="content__cart-img" alt="">  
                                                    </a>
                                                    <div class="content__cart-name">
                                                        <a href="" class="content cart-name-link"><?php echo $value['prd_name']; ?>r</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="product-subtotal">
                                                    <span class="product-subtotal__value"><?php echo $value['prd_price']; ?></span>
                                                </td>
