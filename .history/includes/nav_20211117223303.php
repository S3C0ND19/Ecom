                      ...
                      <p class="headerr__active-link">
                        <div class="header__user-container">
                          ...
                          <div class="user_logout" style="display:none">
                            <a href="logout.php" onclick=handleLogout()>
                        ...
                        <script>
                          ...
                          let listIcon = document.querySelectorAl('.headerr__active-list')
                          console.log(listIcon[3]);
                          function handleLogout(){
                            getIconLogin.style.display = 'block';
                            getAvtUser.style.display = 'none';
                            getBtnLogout.style.display='none';
                          }
                          // jQuery(getUserName).text();
