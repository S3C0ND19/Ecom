                            ...
                            <?php
                                 ...
                                 if (!empty($_SESSION["login"])){
                                  ...
                                  while($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                        <img src="<?php echo "./admin/upload/" .$row['user_img'];?>" alt="" width="30px" height="30px" class="user-avt-deafault" style="display:none;"> 
                                        <span class="username_login"><?php echo $row['user_name']; ?></span>
                                 <?php }
                                }
                            ?>
