                                        ...
                                        <header class="modal-header">
                                          <div class="modal-products-details">
                                              <div class="modal-products-image">
                                                <!-- <img src="./assets/img/cate1.png" alt="" width=100% height=100% style="object-fit:cover;"> -->
                                              </div>
                                              <div class="modal-products-infomation">
                                                <span class="modal-products-name"><?php echo $values["item_name"]; ?></span>
                                                <span class="modal-products-quantity"><?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></span>
                            ...
                            ?> 
                                    <footer class="modal-footer">
                                      <div class="modal-products-total">
                                        ...
                                        <p class="modal-products-total-numbers">$ <?php echo number_format($total, 2); ?>0</p>
                                      </div>
