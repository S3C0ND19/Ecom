                  ...
                  <ul class="headerr__active-item">
                    ...
                    <li class="headerr__active-list header__navbar-user">
                            <ul class="header__navbar-user-menu">
                                ...
                                <li class="header__navbar-user-item profile">
                                    <a href="">My Profile</a>
                                </li>
                                <li class="header__navbar-user-item">
                                    <a href="">View Cart</a>
                                </li>
                                <li class="header__navbar-user-item login">
                                    <a href="login.php">Log In / Register</a>
                                </li>
                                <li class="header__navbar-user-item logout header__navbar-user-item--separate">
                                  <div div class="user_logout"> 
                                    <a href="logout.php" onclick=handleLogout()>Log out</a>                        
                                </div>                                  
                                </li>
                            </ul>
                        ...
                        <script>
                          ...
                          console.log(getUserName.innerText);
                          let profile = document.querySelector('.header__navbar-user-item.profile')
                          let logout = document.querySelector('.header__navbar-user-item.logout')
                          let login = document.querySelector('header__navbar-user-item.login')
