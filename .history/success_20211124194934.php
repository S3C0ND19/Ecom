                                    ...
                                    <div class="success-order-wrapper">
                                        ...
                                        <ul class="success-order-item">
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['firstname']; ?></span>
                                            </li>
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['lastname']; ?></span>
                                            </li>
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['email']; ?></span>
                                            </li>
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['address']; ?></span>
                                            </li>
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['city']; ?></span>
                                            </li>                                
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['phone']; ?></span>
                                            </li>
                                            <li class="success-order-list">
                                                <span class="success-order-details"><?php echo $value['postcode']; ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                <?php  endforeach ?>
