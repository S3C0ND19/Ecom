                        ...
                        <div class="col l-6">
                            <div class="edit-profile">
                                <div class="profile-img">
                                    <img src="./admin/upload/<?php echo $_SESSION["login"][2];?>" alt="" >     
                                </div>
                                <a href="update.php?<?php echo $_SESSION["login"][0]?>" class="profile-link edit">Edit Profile</a>
                            </div>
                        </div>
                        <div class="col l-6">
                            <div class="profile-infomarion">
                                <ul class="profile-infomarion-item">
                                    <li class="profile-infomarion-list">
                                        ...
                                        <span class="profile-infomarion-content"><?php echo $_SESSION["login"][3];?></span>
                                    </li>
                                    <li class="profile-infomarion-list">
