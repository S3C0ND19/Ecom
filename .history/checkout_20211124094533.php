...
if(!empty($_SESSION["shopping_cart"])){
    ...
    while ($values = mysqli_fetch_assoc($ord_prd_id)) {
        echo $row["item_id"];
    }
    
    mysqli_free_result($ord_prd_id);
    echo $ord_prd_id;
                            ...
                            <div class="row">                               
                                    ...
                                    <form action="success.php" method="post" enctype=”multipart/form-data”>
                                        <h3 class="form-heading">Bllling Details</h3>                                      
                                            ...
                                            <div class="form-group">                                               
                                                <input type="hidden" name=ord_prd_id class="form-control form__input" id="form-phone" value="<?php echo  $ord_prd_id; ?>">
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" name=total class="form-control form__input" id="form-phone" value="<?php echo  $total; ?>">
                                            </div>
