                    ...
                    <div class="grid">
                        <div class="row">
                                    ...
                                    <div class="success-order-wrapper">
                                        ...
                                        <ul class="success-order-item">
                                            <li class="success-order-list">
                                                <span class="success-order-details">John Doe</span>
                                            </li>
                                            <li class="success-order-list">
                            ...
                            <div class="col l-4">
                                ...
                                <p class="cart-checkout-heading">Order Summary</p>
                                        <div class="cart-total__content">
                                            ...
                                            <div class="success-checkout-subtotal">
                                                <p>Subtotal</p>
                                                <p class="cart-checkout-subtotal-value">$150</p>
                                            </div>
                                            <div class="success-checkout-total">
                                                <p class="cart-total__title">Shipping & Handling</p>
                                                <p class="total__value" name="total">$12.00</p>
                                            </div>
                                            <div class="success-checkout-total">
                                                <p class="cart-total__title">Tax</p>
                                                <p class="total__value" name="total">$12.00</p>
                                            </div>
                                            <div class="success-checkout-total">
                                                <p class="cart-total__title">Grand Total</p>
                                                <p class="total__value" name="total">$150</p>
                                            </div>
                                        </div>
                                </div>
                            </div>
