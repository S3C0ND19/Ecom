...
// $product = mysqli_query($conn,"SELECT * FROM product  WHERE prd_status='1' ORDER BY prd_id ");
      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>alert("Xóa sản phẩm đã thêm thành công!")</script>';  
                     echo '<script>window.location="shop_paging.php"</script>';  
                }  
           }  
      }  
...
<?php include('includes/header.php'); ?>
    ...
    <script> 
      ...
      //     }
      // });
      $(".btnAddProductCart").click(function(e){
      var action = 'cart';
      e.preventDefault();
      var $form = $(this).closest(".form-submit");
      // var pid = $form.find(".pid").val();
      var pimage = $form.find(".hidden_img").val();
      var pname = $form.find(".hidden_name").val();
      var pprice = $form.find(".hidden_price").val();
      $.ajax({
        url: 'cart.php',
        method: 'post',
        data: {
