  ...
  <tr class="content__cart-actions">
      <td colspan="6" class="actions">
          <div class="content__cart-bottom">
              ...
              <button type="submit" class="btn-submit__update" name="update-cart"  onclick="valueNumber()" value="Update cart">UPDATE CART</button>
          </div>
      </td>
  </tr>
</table>';
...
<?php include('includes/header.php'); ?>
    ...
    <script>
        ...
        var y = document.querySelector(".product-subtotal__value")
        console.log(y)
        ...
        if (defaultVal == currentVal) {
          ...
          document.querySelector(".product-subtotal__value").innerHTML = "'.number_format(currentVal * floatval($values['item_price']), 2).'$"
          
          // "The default value was: " + defaultVal
