                    ...
                    <div class="category-price">
                      ...
                      <div class="category-price__filtter">
                        <div class="category-price__slider">
                          <div class="category-price__range"></div>
                        ...
                        <input type="hidden" id="hidden_minimum_price" value="30" />
                          <input type="hidden" id="hidden_maximum_price" value="350" />
                          <span class="category-price__value-text"></span>
                          <div id="price_range">Range : <span>$30 - $350</span></div>
                        </div>
                      </div>
                    </div>
