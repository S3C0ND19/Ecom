                        ...
                        <div class="row">
                            <div class="col l-8">
                              <!-- Form Cart -->                             
                                ...
                                <div class="emty-cart-checkout">
                                    <img src="./assets/img/empty_cart_retina.png" alt="" width="300px" height="150px" style="object-fit: cover;">
                                    <h3>Hiện tại chưa có sản phẩm nào trong giỏ hàng</h3>
                                    <button type="submit" class="btn-submit__update cart-backshop">BACK TO SHOP</button>
                                </div>                           
                            </div>
                            <div class="col l-4">
                              <!-- Total -->
