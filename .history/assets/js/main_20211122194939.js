...
$(document).ready(function(){
  ...
  $('.slider').slick({
    slidesToShow: 5,
    slidesToScroll: 4,
    nextArrow:"<i class='slick-arrow category_right slick-prev pull-right ti-angle-right'></i>",
    prevArrow:"<i class='slick-arrow category_rleft slick-next pull-left ti-angle-left'></i>",
  });
});
// slider
