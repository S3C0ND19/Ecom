$('.variable-width').slick({
    ...
    variableWidth: true,
    // draggable: true,
    nextArrow:"<i class='slick-arrow right slick-prev pull-right fa fa-angle-right'></i>",
    prevArrow:"<i class='slick-arrow left slick-next pull-left fa fa-angle-left'></i>",
  });
