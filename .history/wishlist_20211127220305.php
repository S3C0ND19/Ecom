        ...
        foreach($_SESSION["wishlist"] as $keys => $values)
        {
            ...
            <tr>
                ...
                <td class="wishlist__product-add">
                    <button method="post" action="shop_paging.php?action=add&id='.$values["item_id"].'" type="submit" name="add_to_cart" class="wishlist__product-add-link">Add to Cart</button>
                </td>
            </tr>
        </tbody>
            ';
