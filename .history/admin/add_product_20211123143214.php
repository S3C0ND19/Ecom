                  ...
                  <div class="form-add-files">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                        ...
                        <label class="dropzone" for="input-img" id="dropzoneFrom2">
                            <div class="dropzone-message-text">
                              <div class="mb-3">
                                <i class=" display-4 text-muted fas fa-cloud-upload-alt"></i>
                              </div>
                                <h4>Drop files here or click to upload.</h4>
                                <input multiple type="file" hidden name="productImage2" autocomplete="off"  id="input-img"class="product__input product__input-img dropzone-img2" />
                            </div>
                        </label>
                      </div>
                    </div>   
