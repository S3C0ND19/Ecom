                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                    <tr>
                                        ...
                                        <td class="table-value" ><?php echo $row['firstname']; ?></td> 
                                        <td>
                                        <a style="font-size:1.5rem" href="delete_order.php?id=<?php echo $row['prd_id']?>" class="btn btn-sm" onclick="return confirm('Are you sure you want to delete this product?');">
