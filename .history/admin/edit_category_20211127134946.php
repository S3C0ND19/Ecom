...
if (isset($_POST['btnEdit'])) {
  ...
  $query = "UPDATE category set cat_name='$name', cat_description='$description', cat_image='$update_filename', cat_status='$status' WHERE cat_id=$id";
                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                          <label class="product__header">Description</label>
                          <textarea style="height:100px;" type="text" class="form-control product__input" required name="categoryDescription"><?php echo $description; ?></textarea>
                      </div>
                    </div>
                  </div>
