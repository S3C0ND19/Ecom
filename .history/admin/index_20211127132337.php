                ...
                <div class="content__selling">
                  ...
                  <div class="content__selling-product">
                    <div class="grid">
                      ...
                      <div class="col l-8">
                        <div class="progress-sm progress">
                          <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="52" aria-valuemin="0"aria-valuemax="100" style="width: 52%;">
                          </div>
                        </div>
                      </div>
                      </div>                    
                  ...
                  <div class="content__selling-product">
                    <div class="grid">
                      ...
                      <div class="col l-8">
                        <div class="progress-sm progress">
                          <div class="progress-bar bg-success" role="progressbar" aria-valuenow="52" aria-valuemin="0"aria-valuemax="100" style="width: 52%;">
                          </div>
                        </div>
                      </div>
                      </div>                    
