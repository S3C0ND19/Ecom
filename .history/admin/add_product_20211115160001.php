                      ...
                      <div class="form-group">
                          <div class="dropzone">
                            <div class="dropzone-message" tabindex="0" >
                                <input multiple type="file" name="productImage" autocomplete="off" tabindex="-1" style="display:none;" class="product__input product__input-img" />
                                <div class="dropzone-message-text">
                                  <div class="mb-3">
                                  <i class=" display-4 text-mutedfas fa-cloud-upload-alt"></i>
                                  </div>
