...
if (isset($_POST['btnEdit'])) {
  ...
  $query = "UPDATE product set prd_name='$name', prd_category='$category',prd_price='$price', prd_image='$update_filename', prd_image_2='$update_filename2', prd_description	='$description', 
                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-add-wrapper">
                        ...
                        <div class="form-group form-add-select-child">
                            ...
                            <select class="form-select" id="category-select" name="sltCategory">
                                <option value="<?php echo $description; ?>"selected><?php echo $description; ?></option>  
                      ...
                      <div class="form-group">
                          ...
                          <textarea style="height:100px;" type="text" class="form-control product__input" name="productDescription"  id="product__description-input" value="<?php echo $description; ?>"></textarea>
                      </div>
                    </div>
                  </div>
