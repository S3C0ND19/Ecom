                ...
                <li class="header__menu-item">
                  <i class="ti-user header__menu-icon"></i>
                    <ul class="header__user-sub-menu">
                      ...
                      <li class="header__user-sub-menu-item">
                        <a href="" class="header__user-sub-link">
                            <i class="header__user-sub-icon ti-more"></i>
                            <span class="header__user-sub-text">Status</span>
                            <i class="header__user-sub-icon right ti-angle-right"></i>
                        </a>
                      </li>
                      <li class="header__user-sub-menu-item">
                        <a href="" class="header__user-sub-link">
                          <svg  class="header__user-sub-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" fit="" height="24px" width="24px" preserveAspectRatio="xMidYMid meet" focusable="false">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                          </svg>
                          <span class="header__user-sub-text">Sign out</span>
                        </a>
                      </li>
                    </ul>
                </li>
