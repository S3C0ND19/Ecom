        ...
        <header class="header">
            ...
            <div class="header__active">
              <ul class="header__menu">
                ...
                <li class="header__menu-item">
                  <ul class="header__multitask-menu">
                  <li class="header__multitask-list">
          ...
          <div class="menu">
            ...
            <li class="navbar__menu-item">
              <div class="navbar__menu-item-wrapper">
                <i class="navbar__menu-icon fas fa-user-tie avtive"></i>
                <a href="#" class="navbar__menu-link avtive">Dashboard</a>
              </div>
