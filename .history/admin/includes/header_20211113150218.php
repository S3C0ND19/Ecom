                ...
                <li class="header__menu-item">
                  ...
                  <div class="header__menu-user-drop">
                    <ul class="header__user-sub-menu">
                        ...
                        <li class="header__user-sub-menu-item">
                          <a href="" class="header__user-sub-link">
                          <svg class="header__user-sub-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="feather feather-help-circle">
                        ...
                        <li class="header__user-sub-menu-item">
                          <a href="" class="header__user-sub-link">
                          <svg class="header__user-sub-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="feather feather-settings">
