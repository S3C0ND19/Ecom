   ...
   <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        dropZoneImg.addEventListener('change', (e) => {
          ...
          if (!file) return
          let img = document.createElement('img').setAttribute("name" , "productImage");
          img.src = URL.createObjectURL(file)
          document.querySelector('#dropzoneFrom').appendChild(img)
         
        })
        let imgForm = document.querySelector('#dropzoneFrom.img');
        imgForm.setAttribute("name" , "productImage");
        // chart
