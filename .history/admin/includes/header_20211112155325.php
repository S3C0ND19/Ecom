                ...
                <div class="header__menu">
                  <div class="header__logo">
                    <a href="" class="header__logo-link">
                      <img src="./upload/logo__shop.png" alt="" class="header__logo-img">
                    </a>
                  </div>
                  <div class="header__nav">
                    <ul class="header__nav-items">
                      <li class="header__nav-lists">
                          <a href="index.php" class="header__nav-link active">DASHBOARD</a>                 
                      </li>
                      <li class="header__nav-lists">
                          <a href="" class="header__nav-link">ORDERS</a>
                      </li>             
                      <li class="header__nav-lists">
                          <a href="product.php" class="header__nav-link">PRODUCT</a>
                      </li>
                      <li class="header__nav-lists">
                          <a href="brand.php" class="header__nav-link">BRAND</a>
                      </li>
                      <li class="header__nav-lists">
                          <a href="category.php" class="header__nav-link">CATEGORY</a>
                      </li>
                      <li class="header__nav-lists">
                          <a href="" class="header__nav-link">CUSTOMERS</a>
                      </li>
                    </ul>
                  </div>
                </div>
