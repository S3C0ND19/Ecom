  ...
  <div class="content">
      ...
      <div class="modal-main">
        <div class="content__header">
          <h3 class="content__title">Eidt Product</h3>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea class="product__input" name="productDescription" placeholder="Enter Product Description" id="product__description-input" value="<?php echo $description; ?>"></textarea>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
