...
<?php include('includes/header.php'); ?>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="row" class="table-header-value" >Product</th>
                            ...
                            <tr style="border-bottom: 1px solid #dee2e6; ">
                                ...
                                <td>
                                    <a style="font-size:1.5rem; margin-right:20px;" href="edit_category.php?id=<?php echo $row['cat_id']?>" class="btn btn-sm ">
                                       ...
                                       <button class="addHTML" onclick="openModal()">
                                       <a style="font-size:1.5rem" class=" addhref btn btn-sm">
    ...
    <div class="modal-delete" id="modal-id">
        <div class="modal-delete-container">
            <div class="modal-delete-content">
                <div class="modal-delete-heading">
                  <h3>Delete</h3>
                  <i  onclick="hideModal()" class=" icon-close-modal-delete fas fa-times"></i>
                </div>
                <div class="modal-delete-description">
                  <p>Are you sure you want delete this? This action cannot be undone</p>
                </div>
                <div class="modal-delete-footer">
                  <button type="button" onclick="hideModal()" class="btnCancelDelete modal-delete-btn ">Cancel</button>
                  <button type="button" onclick="hideModal()" class="btnConfirmDelete modal-delete-btn ">Delete</button>
                </div>
            </div>
        </div>
      </div>
