...
if (isset($_POST['btncreate'])) {
  ...
  $category = $_POST['sltCategory'];
    $query = "INSERT INTO product (prd_name,prd_status,prd_price, prd_price_old, prd_image, prd_image_2, prd_description, prd_quantity, prd_brand, prd_date, prd_sale, prd_cat_id) 
    VALUES ('$name','$status','$price','$old_product' ,'$new_image','$new_image2', '$description', '$quantity','$brand', '$date', '$sale' , '$category')";
                      ...
                      <div class="form-add-wrapper">
                        ...
                        <div class="form-group form-add-select-child">
                            ...
                            <select class="form-select" id="category-select" name="sltCategory">
                                ...
                                <option value="12">Seating</option>
                                <option value="13">Sofas</option>
                                <option value="14">Special</option>
                                <option value="15">Table</option>
                                <option value="16">Living Room</option>
                            </select>
                        </div>
                      </div>                    
                      <div class="form-add-wrapper">
