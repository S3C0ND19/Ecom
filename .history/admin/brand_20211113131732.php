                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #dee2e6; ">
                                ...
                                <td>
                                    <a style="font-size:1.5rem; margin-right:20px;" href="edit_brand.php?id=<?php echo $row['cat_id']?>" class="btn btn-sm ">
                                        <i class="fas fa-marker"></i>
                                    </a>
                                    <a style="font-size:1.5rem" href="delete_brand.php?id=<?php echo $row['cat_id']?>" class="btn btn-sm">
