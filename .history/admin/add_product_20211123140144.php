                  ...
                  <div class="form-add-files">
                    ...
                    <div class="form-add-content">
                      <div class="form-group">
                        ...
                        <input multiple type="file" hidden name="productImage" autocomplete="off"  class="product__input product__input-img dropzone-img" />
                      ...
                      <div class="form-group">
                        ...
                        <input multiple type="file" hidden name="productImage2" autocomplete="off"  class="product__input product__input-img" />
                      </div>
                    </div>   
                  </div>              
