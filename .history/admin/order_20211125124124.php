            ...
            <div class="content__table">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT DISTINCT order_prd_id.order_id ,order_prd_id.user_id, .order_prd_id.product_id , .order_prd_id.order_status  FROM  order_prd_id  
                                  inner join user on  order_prd_id.user_id = user.user_id
                                  inner join purchase on  user.user_id = purchase.purchase_user_id
                                  WHERE purchase.purchase_user_id= order_prd_id.user_id";
