                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                          ...
                          <textarea type="text" class="form-control product__input" name="productDescription" placeholder="Enter Product Description" id="product__description-input"></textarea>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="form-add-files">
                    ...
                    <div class="form-add-content">
                      <div class="form-group">
                          ...
                          <input type="file" name="productImage" class="product__input product__input-img form-control" />
                      </div>
                    </div>   
                  </div>              
