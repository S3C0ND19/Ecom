                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-add-wrapper">
                        <div class="form-group form-add-input-child-4 ">
                            ...
                            <input type="text" class="form-control product__input" name="productPrice" />                      
                        </div>
                        <div class="form-group form-add-input-child-4 ">
                        ...
                        <div class="form-group form-add-input-child-4">
                            ...
                            <input type="number" class="form-control product__input" name="productQuantity"/>
                        </div>
                        <div class="form-group form-add-input-child-4">
                            <label class="product__header">Discount</label>
                            <input type="text" class="form-control product__input" name="productSale" />
                        </div>
                      </div>
                      <div class="form-group">
