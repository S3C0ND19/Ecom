...
if (isset($_POST['btnEdit'])) {
  ...
  if ($password !=  $renew_password){
    ...
    $update_password = $_POST['userNewPassword'];
  }
  $query = "UPDATE user set user_level='$level',user_img='$update_filename',user_name='$name', user_email='$email', user_username ='$username', user_password='$old_password',user_address='$address', user_contact='$contact' WHERE user_id=$id";
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-add-wrapper">
                        <!-- <div class="form-group form-add-input-child ">
                            ...
                            <input type="password" class="form-control form__input" name="userPassword"/>                      
                        </div> -->
                        <div class="form-group form-add-select-child">
