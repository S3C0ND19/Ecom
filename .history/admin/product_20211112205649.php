            ...
            <div class="product__table">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="row" style="font-size:1.5rem; padding-bottom:20px;">Image</th>
                                <th scope="row"style="font-size:1.5rem">Name</th>
                                <th scope="row"style="font-size:1.5rem">Category</th>
                                <th scope="row"style="font-size:1.5rem">Price</th>
                                <th scope="row"style="font-size:1.5rem">Quantity</th>
                                <th scope="row"style="font-size:1.5rem">Brand</th>
                                <th scope="row"style="font-size:1.5rem">Sale</th>
                                <th scope="row"style="font-size:1.5rem">Date</th>
                                <th scope="row"style="font-size:1.5rem">Action</th>
                            </tr>
                        </thead>
                        <tbody id="product_list">
                            ...
                            <tr>
                                <td>
                                    <img src="<?php echo "./upload/" .$row['prd_image'];?>" width="60px" height="60px" alt="" style="transform: translateY(20px);">     
                                </td>
