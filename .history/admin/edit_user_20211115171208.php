                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-add-wrapper">
                        ...
                        <select class="form-select" name="sltLevel">
                      ...
                      <div class="form-add-wrapper">
                        ...
                        <div class="form-group form-add-input-child">
                            ...
                            <input type="password" class="form-control form__input" name="userPassword" required/>  
                        </div>
                      </div>
                      <div class="form-add-wrapper">
                        <div class="form-group form-add-input-child ">
                  ...
                  <div class="form-add-files">
                    ...
                    <div class="form-add-content">
                      <div class="form-group">
                        ...
                        <input multiple type="file" name="userImage" autocomplete="off"  class="product__input product__input-img" />
