  ...
  <div class="content">
      ...
      <div class="modal-main">
        ...
        <div class="modal-body">
            <form action="edit_category.php?id=<?php echo $_GET['id']; ?>"class="form-add-product" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                          ...
                          <textarea style="height:100px;" type="text" class="form-control product__input" name="categoryDescription"></textarea>
                      </div>
                    </div>
                  </div>
