...
$info = mysqli_query($conn,
    ...
    WHERE purchase_id = $id AND purchase.status = '1' ");
?>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="row" class="table-header-value" style="text-align:center;">Product Image</th>
                        ...
                        <tbody>
                                <tr>                                   
                                    ...
                                    <td class="table-value" style="max-width: 300px;">
