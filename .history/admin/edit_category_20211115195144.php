                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                            ...
                            <input type="number" class="form-control product__input" name="categoryQuantity" required value="<?php echo $quantity; ?>"/>
                      </div>                    
                      <div class="form-group">
                          <label class="product__header">Description</label>
                          <textarea style="height:100px;" type="text" class="form-control product__input" required name="categoryDescription" value="<?php echo $description; ?>"></textarea>
                      </div>
                    </div>
                  </div>
