                  ...
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                          ...
                          <textarea style="height:100px;" type="text" class="form-control product__input" name="productDescription" placeholder="Enter Product Description" id="product__description-input"></textarea>
                      </div>
                    </div>
                  </div>
