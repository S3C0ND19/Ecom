                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM  order_prd_id  
                                  ...
                                  WHERE  purchase.purchase_user_id= order_prd_id.user_id GROUP BY purchase.purchase_user_id";
                                ...
                                while($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a style="font-size:1.5rem" href="edit_order.php.php?id=<?php echo $row['purchase_id']?>" class="btn btn-sm" onclick="return confirm('Are you sure you want to delete this product?');">
