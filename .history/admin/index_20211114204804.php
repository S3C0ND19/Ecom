      ...
      <div class="content-main">
            ...
            <div class="row">
              ...
              <div class="col l-3">
                 <div class="data__wrapper">
                   <div class="data__statistical">
                     <div class="data__statistical-total">
                       <span class="data__statistical-numbers">5,643</span>
              ...
              <div class="col l-3">
                 <div class="data__wrapper">
                   <div class="data__statistical">
                     <div class="data__statistical-total">
                       <span class="data__statistical-numbers">45,254</span>
                       <span class="data__statistical-text">Customers</span>
                     </div>
                     <div class="data__statistical-icon">                   
              ...
              <div class="col l-3">
                 <div class="data__wrapper">
                   <div class="data__statistical">
                     <div class="data__statistical-total">
                       <span class="data__statistical-numbers">+12.58%</span>
                       <span class="data__statistical-text">Growth</span>
                     </div>
                     <div class="data__statistical-icon">                   
            ...
            <div class="row">
              ...
              <div class="col l-4">
                <div class="content__selling">
                  <h3 class="content__selling-header">Top Sellling Product</h3>
        ...
        <div class="content__information">
          <div class="grid">
            <div class="row">
              <div class="col l-4">
                <div class="content__information-user">
              ...
              <div class="col l-4">
                <div class="content__information-active">
                  <h3 class="content__information-heading">Recent Activity</h3>
                  <ul class="content__information-menu">
                    <li class="content__information-menu-item">
                      ...
                      <p>Andrei Coman magna sed porta finibus, risus posted a new article:<span>Forget UX Rowland</span></p>
                    </li>
                  </ul>
