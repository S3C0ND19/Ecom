...
if (isset($_POST['btncreate'])) {
  ...
  $cat_id = $_POST['productCatid'];
    $query = "INSERT INTO product (prd_name, prd_category, prd_price, prd_price_old, prd_image,prd_image_2, prd_description, prd_quantity, prd_brand, prd_date, prd_sale, prd_Cat_id) VALUES ('$name','$category' ,'$price','$old_product' ,'$new_image','$new_image2', '$description', '$quantity','$brand', '$date', '$sale' , '$cat_id')";
                ...
                <div class="form-content-add">                   
                  <div class="form-add-input">
                    ...
                    <div class="form-add-content">
                      ...
                      <div class="form-group">
                          <label class="product__header" for="product__description-input">Product Category</label>
                          <textarea style="height:100px;" type="text" class="form-control product__input" name="productCatid"  id="product__description-input"></textarea>
                      </div>
                    </div>
                  </div>
