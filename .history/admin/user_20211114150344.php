                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #dee2e6; ">
                                ...
                                <td>
                                    <span class="bg-pill font-size-12 bg-soft-success badge badge-secondary badge-pill">
                                    <?php 
                                        if($row["user_level"] == 1)
                                            echo "Admin";
                                        else
                                ...
                                <td style="padding-bottom: 25px;font-size:1.5rem;"><?php echo $row['user_address']; ?></td>
