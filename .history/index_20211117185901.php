<?php
	...
	if(isset($_POST['btnSignIn'])){
		...
		$sqlLogin = "SELECT * FROM user WHERE user_username ='$username' AND user_password ='$password' AND user_level = 0 LIMIT 1";
      ...
      <div class="category">
        <div class="category__container">
          ...
          <div class="category__product">
            <i class="category__icon-left fa fa-angle-left"></i>
            ...
            <div class="category__product-wrapper-img hidden">
              <a href="" class="category-link">
                <img src="./assets/img/cate3.jpg" alt="" class="category__product-img">
              </a>
               <div class="category__product-link">
            ...
            <i class="category__icon-right fa fa-angle-right"></i>
          </div>
        </div>
      </div>
      <!-- Collections -->
...
<?php session_unset(); } ?>
              <form class="register"  action="register_submit.php" method="POST">
                <div class="modal-heading">
                  <h2 class="modal-heading__text">REGISTER</h2>
                </div>
                <div class="form-content">
                  <div class="username">
                    <input type="text" class="form__input" name="userName" required placeholder="Username...">
                  </div>
                  <div class="email">
                    <input type="email" class="form__input"  name="userEmail" required placeholder="Email...">
                  </div>
                  <div class="password">
                    <input type="password" class="form__input"  name="userPassword" required placeholder="Password...">
                  </div>
                  <div class="password">
                    <input type="password" class="form__input"  name="userRePassword" required placeholder="Repeat Password...">
                  </div>
                  <div class="button-resgister">
                    <input type="submit" name="btnRegister" class="btn-resgister__click" value="RESGISTER">
                  </div>
