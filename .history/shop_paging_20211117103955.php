                  ...
                  <div class="category">
                    <nav class="category-nav">
                      ...
                      <?php foreach ($navigation as $key => $value): ?>     
                        ...
                        <input type="checkbox" hidden class="common_selector category " id="category__check" value="<?php echo $value['cat_id'];?>" >                          
                          <label for="category__check">                         
                            <p class="category-item__link"><?php echo $value['cat_name'];?></p>
                          </label>
