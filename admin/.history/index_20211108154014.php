...
<?php include('includes/header.php'); ?>
        ...
        <?php
        $sql = "select cat_image from category where id=1";
          ...
          <div class="navigation__product">
            <div class="navigation__product-wrapper">
              <a href="" class="navigation__product-link">
                ...
                <img src="<?php echo "./upload/" .$row['cat_image'];?>" class="navigation__product-img" alt="">
                <img src='<?php echo $image_src;  ?>' class="navigation__product-img" alt="">
              </a>
              <a href="" class="navigation__product-name">BATH ROOM</a>
            </div>
            <div class="navigation__product-wrapper">
              <a href="" class="navigation__product-link">
            ...
            <div class="navigation__product-wrapper">
              <a href="" class="navigation__product-link">
                <img src="./assets/img/shop__nav/nav-img-5.jpg" alt="" class="navigation__product-img">
              </a>
                            ...
                            <div class="products-thumb">
                              ...
                              <div class="products-wrapper__img">
                                <a href="" class="products-details-link">
                                  ...
                                  <img src="getImage.php?id=4" class="products-img" />
                                </a>
                              </div>                 
