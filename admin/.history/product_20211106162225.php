                        ...
                        <form action="" class="form-add-product">
                            <div class="form-content">
                                ...
                                <div class="modal-product__description">
                                    ...
                                    <input type="text" class="product__description-input" name="productDescription" required placeholder="Enter Product Description">
                                </div>
                                <div class="modal-product__price">
                                        <label class="product__header">Product Price</label>
                                        <input type="text" class="product__input" name="productName" required placeholder="Enter Product Price">
                                </div>
