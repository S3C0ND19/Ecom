      ...
      <?php session_unset(); } ?>
        ...
        <div class="table-responsive">
            ...
            <tbody id="product_list">
                <?php
                    $query = "SELECT * FROM prd_details";
                    $result_tasks = mysqli_query($conn, $query);    
                    while($row = mysqli_fetch_assoc($result_tasks)) { ?>
                <tr>
                    <td>#</td>
                    <td style="font-size:1.5rem"><?php echo $row['prd_name']; ?></td>
                    <td><?php echo '<img src="upload/'.$row['prd_image'].'"width="100px;" height="100px;" alt="Image">'?></td>
                    <td><img src="upload/<?php echo $row['prd_image']?>" style="width:100px;height:100px"></td>
            ...
            <div class="modal-content">
                ...
                <div class="box-content">
                    <div class="form-wrapper active" >
                        ...
                        <form action="add_product.php" class="form-add-product" method="POST"> 
                            <div class="form-content">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="number" class="product__input" name="productSale" required placeholder="Enter Product Sale" id="product__sale-input">
                                </div>       
