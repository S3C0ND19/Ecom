                        ...
                        <form action="add_brand.php" class="form-add-product" method="POST" enctype="multipart/form-data"> 
                            <div class="form-content">
                                <div class="modal-product__name">
                                    <label for="product__name-input" class="product__header">Brand Name</label>
                                    <input type="text" class="product__input" name="brandName" required placeholder="Enter Brand Name" id="product__name-input">
                                </div>
