...
$new_product = mysqli_query($conn,"SELECT * FROM category ORDER BY cat_id DESC LIMIT 5");
?>
...
<div class="navigation">
          ...
          <div class="navigation__product">
            ...
            <div class="navigation__product-wrapper">
              ...
              <img src="./upload/<?php echo $value['cat_name']; ?>" alt="" class="navigation__product-img" alt=""/>   
            </div>
            <?php  endforeach ?>
          </div>
        </div>
