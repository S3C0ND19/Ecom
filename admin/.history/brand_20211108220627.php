        ...
        <div class="table-responsive">
            ...
            <tbody id="product_list">
                ...
                <tr>
                    ...
                    <td>
                        <a style="font-size:1.5rem" href="edit_brand.php?id=<?php echo $row['brand_id']?>"class="btn btn-sm btn-info btnEditBrand">
                            <i class="fas fa-marker"></i>
                        </a>
                        <a  style="font-size:1.5rem" href="delete_brand.php?id=<?php echo $row['brand_id']?>" onclick="return confirm('Are you sure you want to delete this brand?');" class="btn btn-sm btn-danger">
