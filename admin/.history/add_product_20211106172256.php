...
if (isset($_POST['add_product'])) {
  ...
  $query = "INSERT INTO prd_details(prd_name, prd_price, prd_image, prd_description, prd_quantity, prd_date, prd_sale) VALUES ('$prd_name', $prd_price,'$prd_image', '$prd_description', $prd_quantity, $prd_date, $prd_sale)";
