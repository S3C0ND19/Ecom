        ...
        <div class="table-responsive">
            ...
            <tbody id="product_list">
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo "./upload/filter-latest5.1.jpg" .$row['prd_image'];?>" width="100px" height="100px" alt="" />
                        <!-- <td colspan ='4'>
                            <img src="\Pics\H.gif" alt="" border='3' height='100' width='100' />
                        </td> -->
                    </td>
                        ...
                        <form action="add_product.php" class="form-add-product" method="POST" enctype="multipart/form-data"> 
                            <div class="form-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="productImage_old" value="<?php echo $row['prd_image'];?>">
                                </div>
