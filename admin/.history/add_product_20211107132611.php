...
if (isset($_POST['btncreate'])) {
  ...
  if (file_exists("./upload/" . $_FILES['productImage']['name'])){
    ...
    $query = "INSERT INTO prd_details (prd_name, prd_price, prd_image, prd_description, prd_quantity, prd_date, prd_sale) VALUES ('$name', '$price','$update_filename', '$description', '$quantity', '$date', '$sale')";
